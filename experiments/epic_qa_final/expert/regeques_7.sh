...
export RQE_RUN_NAME=HLTRI_REGEQUES_FINAL_7
...
export RGQE_SELF_THRESHOLD=0.004
export RGQE_TOP_C_THRESHOLD=0.004
...
export RQE_MODEL_NAME=RQE-q_hier-HLTRI_COVID_RQE_rqe-16
export RQE_MODEL_SAVE_DIRECTORY=models/rqe
